/**
 ...
 Problem: Program with methods aside from the main method (Program Decomposition is applied)
...
// compute the average
     ...
     */
    public static void parallelSort(String[] c, int[] q, int[] e, double[] p, double[] a,
                                    double[] i) {
        for (int x = 0; x < c.length - 1; x++) {
            for (int y = x + 1; y < c.length; y++) {
                if (c[x].compareToIgnoreCase(c[y]) > 0) {
     ...
     */
    public static void parallelSortD(String[] c, int[] q, int[] e, double[] p, double[] a,
                                     double[] i) {
        for (int x = 0; x < c.length - 1; x++) {
            for (int y = x + 1; y < c.length; y++) {
                if (i[x] < (i[y])) {
