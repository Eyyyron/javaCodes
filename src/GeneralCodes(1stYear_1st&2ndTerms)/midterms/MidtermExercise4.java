/**
 ...
 Activity Name: MidtermExercise4

 Problem:
 Write an improved version of the program that will provide validation processes for the input values. The
 following should be imposed: (Filename: MidtermExercise4.java)
 ...
 another value. The user may repeatedly supply an invalid value. The processing should continue only after the
...
public class MidtermExercise4 {
    public static void main(String[] args) {
        ...
        System.out.print("Product (pen, pencil, short bond paper, long bond paper, pad paper): ");
        pName = keyboard.nextLine();

        switch (pName) {
            case "pen", "pencil", "short bond paper", "long bond paper", "pad paper" -> System.out.println();
            default -> {
