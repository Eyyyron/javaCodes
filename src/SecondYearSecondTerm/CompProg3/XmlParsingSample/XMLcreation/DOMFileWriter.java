...
public class DOMFileWriter {
    public static void main(String[] args) {
        ...
        writeDOMToFile(document.getFirstChild(),
                "res/departments.xml");

        document = retireFaculty(document, "Dina Matuto");
        writeDOMToFile(document.getFirstChild(),
                "res/updated_departments.xml");
    }
    ...
    private static Document retireFaculty(Document document, String emp) {
        ...
        // remove departments that don't have any employee using Element class
    ...
    private static Document createDocument() {
        ...
        try {
            ...
            assignFacultyToDepartment(department, document,
                    "full-time", "10", "Pedro Penduko");
            assignFacultyToDepartment(department, document,
                    "contractual", "100", "Juan Masipag");
            assignFacultyToDepartment(department, document,
                    "full-time", "5", "Dina Matuto");
    ...
    private static void assignFacultyToDepartment(Element department,
            Document doc, String status, String id, String name) {
        ...
        // set sub-elements of the employee
        employee.appendChild(empID);
        employee.appendChild(empName);
        // set the employee as sub-element of the department
