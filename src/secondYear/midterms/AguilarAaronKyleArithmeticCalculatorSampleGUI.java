...
public class AguilarAaronKyleArithmeticCalculatorSampleGUI extends JFrame {
    ...
    public AguilarAaronKyleArithmeticCalculatorSampleGUI(){
    ...
    public static void main(String[] args){
        AguilarAaronKyleArithmeticCalculatorSampleGUI calculatorObject = new AguilarAaronKyleArithmeticCalculatorSampleGUI();
    }
} // end of class
